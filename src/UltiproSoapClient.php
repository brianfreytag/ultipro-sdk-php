...
class UltiproSoapClient
{
     ...
     */
    public function __construct($auth, string $baseUri = 'https://service5.ultipro.com/services/BIDataService', array $options = [], LoggerInterface $logger)
    {
    ...
    {
        $headers = [
            new SoapHeader('http://www.w3.org/2005/08/addressing', 'Action', 'http://www.ultipro.com/dataservices/bidata/2/IBIDataService/LogOff', true),
            new SoapHeader('http://www.w3.org/2005/08/addressing', 'To', 'https://service5.ultipro.com/services/BiDataService', true)
        ];
        ...
        try {
            ...
            $this->getLogger()->error(
                'There was an error logging off of the Ultipro SOAP API',
                [
                    'message'       => $e->getMessage(),
                    'last_request'  => $client->__getLastRequest(),
                    'last_response' => $client->__getLastResponse()
